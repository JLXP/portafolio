      ...
      <div className="w-full flex flex-col md:flex-row  justify-center">
        ...
        <div className='w-full lg:w-3/6 px-6 lg:px-12 flex items-center'>
          <div className="lg:bg-[#000a12] p-6 flex flex-col lg:absolute lg:left-1/3 lg:mr-10">
            ...
            <span className="text-lg text-white py-2">Me encanta aprender algo nuevo todos los días ya sea sobre desarrollo web, móvil o todo lo que concierne al cambio tecnológico que sucede en el mundo.
